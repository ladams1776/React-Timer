import fetchApiDataWithFlashMessageAndReduxActions from '../fetchApiData';

describe('src/utils/api/fetchApiData/__test__/fetchApiDataWithFlashMessageAndReduxActions.test.js', () => {
  describe('fetchApiDataWithFlashMessageAndReduxActions', () => {
    // Arrange
    ...
    it('should successfully call fetch with a GET method type', async () => {
      ...
      // Act
      await fetchApiDataWithFlashMessageAndReduxActions(url, {}, dispatchSpy);
    ...
    it('should successfully call fetch with a POST method type, when passing in a body', async () => {
      ...
      // Act
      await fetchApiDataWithFlashMessageAndReduxActions(url, settings, dispatchSpy);
